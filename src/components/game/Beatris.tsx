...
import { ChevronDown, ChevronLeft, ChevronRight, Pause, Play, RotateCw, Volume2, VolumeX } from "lucide-react";
...
export function Beatris(){
  ...
  return <main className="v20-shell">
    <header className="v20-top">
      <div><div className="v20-kicker">BEATRIS // v0.20 CORE</div><h1>HOUSE INSTRUMENT</h1></div>
    ...
    <section className="v20-grid">
      ...
      <section className="v20-game">
        <div className="v20-well">
          ...
          {mode==="title"?<div className="v20-overlay"><div className="start-card"><span>FROZEN CORE EXPERIMENT</span><h2>PLAY THE GROOVE.</h2><p>124 BPM. Kick 1-2-3-4 y clap 2/4 son fijos. Cada lock deja huella. I = sweep. T = stab. Limpiar filas viste el House; apilar solo crea tensión.</p><button onClick={start}>START CORE</button><small>Demucs OUT · no selector · no escenas narrativas</small></div></div>:null}
      ...
      <aside className="v20-panel music-panel">
        ...
        <div className="grammar"><div><b>I</b><span>SWEEP · alta banda</span></div><div><b>T</b><span>STAB · síncopa</span></div><div><b>HARD @ 1</b><span>BODY + CRASH</span></div><div><b>HARD OFF</b><span>DRY RIM</span></div></div>
    ...
    <footer className="v20-tests"><span>01 LOCK</span><span>02 I ≠ T</span><span>03 HARD @1 ≠ OFF</span><span>04 CLEAR GRAMMAR</span><span>05 NO 8-BAR COPY</span><span>06 HEAD-NOD</span><span>07 CLEARS IMPROVE · STACK DOESN'T</span></footer>
  </main>;
}
